...
public class CropImageView extends TransformImageView {
        ...
        if (mBitmapLaidOut && !isImageWrapCropBounds()) {
            ...
            if (animate) {
                post(mWrapCropBoundsRunnable = new WrapCropBoundsRunnable(
                        com.luck.picture.lib.ucrop.view.CropImageView.this, mImageToWrapCropBoundsAnimDuration, currentX, currentY, deltaX, deltaY,
    ...
    protected void zoomImageToPosition(float scale, float centerX, float centerY, long durationMs) {
        ...
        post(mZoomImageToPositionRunnable = new ZoomImageToPosition(com.luck.picture.lib.ucrop.view.CropImageView.this,
    ...
    private static class WrapCropBoundsRunnable implements Runnable {
        ...
        private final WeakReference<com.luck.picture.lib.ucrop.view.CropImageView> mCropImageView;
        ...
        public WrapCropBoundsRunnable(com.luck.picture.lib.ucrop.view.CropImageView cropImageView,
                                      long durationMs,
        ...
        @Override
        public void run() {
            com.luck.picture.lib.ucrop.view.CropImageView cropImageView = mCropImageView.get();
    ...
    private static class ZoomImageToPosition implements Runnable {
        ...
        public ZoomImageToPosition(com.luck.picture.lib.ucrop.view.CropImageView cropImageView,
                                   long durationMs,
                                   float oldScale, float deltaScale,
